            ...
            <Grid
                ...
                <Grid item xs={4}>
                    <Item sx={{ fontSize: 12, boxShadow: 'none' }}> IHCL Sustainability Report 2020-21
                        <Button size='small' className='pdfbuttonsant' sx={{ marginTop: 3, left: 10, border: 'none', fontSize: 11, boxShadow: 'none' }} href="#contained-buttons">
                            DOWNLOAD PDF
                        </Button>
                    </Item>
                </Grid>
                ...
                <Grid item xs={4}>
                    <Item sx={{ fontSize: 12, boxShadow: 'none' }}>Safety & Security
                        <Button size='small' className='pdfbuttonsant' sx={{ marginTop: 3, left: 68, border: 'none', fontSize: 11, boxShadow: 'none' }} href="#contained-buttons">
                            DOWNLOAD PDF
                        </Button>
                    </Item>
                </Grid>
